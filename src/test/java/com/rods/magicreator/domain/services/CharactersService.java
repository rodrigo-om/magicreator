package com.rods.magicreator.domain.services;
...
@Service
@Slf4j
public class CharactersService implements IManageCharacters {
    ...
    public void delete(String id) throws CouldNotDeleteCharacterException {
        ...
        } catch (IStoreCharacters.ErrorDeletingCharacterException e) {
            log.error("Could not search for characters.", e);
